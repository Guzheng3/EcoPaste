...
export const TAURI_COMMAND = {
  ...
  EXTRACT_ITEM_ENTITIES: "extract_item_entities",
  FILL_SELECTED_TEXT: "fill_selected_text",
  ...
  OPEN_ENTITY_LINK: "open_entity_link",
  ...
  SEGMENT_CLIPBOARD_ITEM: "segment_clipboard_item",
