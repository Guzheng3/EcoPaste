...
* auto-restart the app on monitor configuration change (resolution / scale / display hot-plug) and reset saved window geometry so the popup fits the new resolution
...
* remove residual native border after copied toast fades out
